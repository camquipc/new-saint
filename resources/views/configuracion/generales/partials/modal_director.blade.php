<!-- Modal -->
<div class="modal fade" id="modalNuevoDirector" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        {!! Form::open(['url' => 'configuracion/generales/directivo','method' =>'POST'] ) !!}
        <div class="card">
          <fieldset>
            ...
            <div class="card-body card-block p-2">
              <div class="row">
                @include('configuracion.generales.partials.form')
              </div>
            </div>
