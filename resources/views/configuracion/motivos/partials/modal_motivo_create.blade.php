<!-- Modal -->
<div class="modal fade" id="modalNuevoMotivo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
        ...
        <div class="card">
          <fieldset>
            ...
            <div class="card-body card-block p-2">
              <div class="row">
                @include('configuracion.motivos.partials.form')
              </div>
            </div>
