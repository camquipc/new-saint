<!-- Modal -->
<div class="modal fade" id="modalOticDepartamento" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Divisiónes OTIC</h5>
        ...
        <div class="card">
          <fieldset>
            ...
            <div class="card-body card-block p-2">
              <div class="row">
                @include('configuracion.divisiones.partials.form')
              </div>
            </div>
